...
import com.orane.icliniqlite.adapter.FamilyListAdaptor;
...
public class FamilyProfileListActivity extends AppCompatActivity implements ObservableScrollViewCallbacks {
    ...
    String dob_val,fee_str_text, icq100_id_val, inf_for, Log_Status, mem_name, wt_name, height_name, tit_id, age_val, gender_val, height_val, weight_val, relation_type_val, radio_id, myself_id, famDets_text, fam_response, relation_value, tit_name, tit_val;
...
*//*                    System.out.println("qtitle_textval-------------" + Docname);
    ...
    public void ask_someone(String add_type) {
        ...
        final RadioGroup radgrp_gender = alertLayout.findViewById(R.id.radgrp_gender);
