...
public class QueryListAdapter extends ArrayAdapter<Item> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.btn_qview = view.findViewById(R.id.btn_qview);
        holder.btn_qedit = view.findViewById(R.id.btn_qedit);
        holder.status_icon = view.findViewById(R.id.status_icon);
        holder.lable_bullet = view.findViewById(R.id.lable_bullet);
        holder.tv_read_status = view.findViewById(R.id.tv_read_status);
        holder.tvquery = view.findViewById(R.id.tvquery);
        holder.tvstatus = view.findViewById(R.id.tvstatus);
        holder.tv_qid = view.findViewById(R.id.tv_qid);
        holder.tvdate = view.findViewById(R.id.tvdate);
        holder.tv_hlstatus = view.findViewById(R.id.tv_hlstatus);
        holder.tv_doctname = view.findViewById(R.id.tv_doctname);
        holder.tv_qtype = view.findViewById(R.id.tv_qtype);
        holder.tv_consulted_for = view.findViewById(R.id.tv_consulted_for);
        holder.tv_paynow = view.findViewById(R.id.tv_paynow);
        holder.tvstatus_answered = view.findViewById(R.id.tvstatus_answered);
        holder.answered_layout = view.findViewById(R.id.answered_layout);
        holder.draft_layout = view.findViewById(R.id.draft_layout);
        holder.awaiting_layout = view.findViewById(R.id.awaiting_layout);
        ...
        if (holder.tv_read_status != null && null != objBean.getArtAbs() && objBean.getArtAbs().trim().length() > 0) {
            holder.tv_read_status.setText(Html.fromHtml(objBean.getArtAbs()));
        }
    ...
    public class ViewHolder {
        ...
        public TextView tvquery, tv_read_status, tvstatus_answered, tv_paynow, tv_consulted_for, tvstatus, tv_doctname, tv_qid, tvdate, lable_bullet, tv_hlstatus, tv_docurl, tv_qtype;
