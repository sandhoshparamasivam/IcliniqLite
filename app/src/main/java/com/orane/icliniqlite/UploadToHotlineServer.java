    ...
    /* public int uploadFile() {
         ...
         if (!sourceFile.isFile()) {
             ...
             try {
                 ...
                 conn. 1. Create Sample Bags, 2. Create Documents - sizes, prices etc..
                 conn. 3. Catalog,Visiting Card, Order form, Invoice book, Seal, Letter pad,
                 conn. 4. Depart - Markt, purchase, stock, Production, Despatch, sales, transport
                 conn. 5. Markt tricks - By through, Social Media, Events Partners etc...
                 conn. 6. Online order, user order history,
                 conn. 7. offers : Discount orders, Tie-up offers,
