...
public class LoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtpassword = (ShowHidePasswordEditText) findViewById(R.id.edtpassword);
        ...
        protected void onPostExecute(Boolean result) {
            ...
            try {
                ...
                if (isvalid.equals("true")) {
                    ...
                    Model.mobile_no = login_jsonobj.getString("m_num");
...
/*
                    ...
                    editor.putString(mobile_no, Model.mnum);
                    ...
                    Intent i = new Intent(LoginActivity.this, Lite_Home_Activity.class);
                    startActivity(i);
                    finish();
