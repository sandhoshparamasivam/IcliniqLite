...
public class OTPActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_mobsubmit = findViewById(R.id.btn_mobsubmit);
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (otp_text.equals(pin_val)) {
                    ...
                    finishAffinity();
                    Intent i = new Intent(OTPActivity.this, Lite_Home_Activity.class);
                    startActivity(i);
                    finish();
                    ...
                    Toast.makeText(OTPActivity.this, "The OTP you have entered is incorrect. Please enter the valid OTP.", Toast.LENGTH_SHORT).show();
        ...
        btn_mobsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    phoneno_text = edt_phoneno.getText().toString();
/*                    cccode = tv_ccode.getText().toString();
                    cccode.replaceAll("\\+","");*/
...
/*          dialog = new ProgressDialog(OTPActivity.this);
            ...
            1. Voucher, ID Card, Tariff, Channel Broucher, Accounts Notes, Bill Files,
            dialog.show();
            dialog.setCancelable(false);*/
        }
